...
Full Load: Captures complete source snapshots.

Incremental Load: Tracks new and modified records using watermark tracking.

CDC Load: Captures INSERT, UPDATE, and DELETE operations via SQL Server Change Data Capture.
...
Gold: Consolidates data into current-state datasets and business-oriented dimensional models (Fact and Dimension tables).
